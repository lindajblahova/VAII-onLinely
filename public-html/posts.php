...
<div class="row">
    <div class="col-lg-12">
            ...
            <?php foreach ($dbPostsList as $dbPostRow) { ?>
                ...
                <div><td class="message_content"><?php echo $dbPostRow["post_content"]; ?></td></div>
                ...
                <form action="posts.edit.controller.php" method="post" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        { echo 'is-valid'; }else{ echo (phpShowInputFeedback($_SESSION['msgid'])[0]); } ?>"
                                  ...
                                  onkeyup="jsPostsValidateTextArea('formPostsContentEdited<?php echo $dbPostRow['post_id'];?>')" hidden>
                    ...
                    <a href="#formPostsContentEdited<?php echo $dbPostRow['post_id'];?>" class="btn btn-primary btn-sm" role="button"
